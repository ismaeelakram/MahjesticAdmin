    ...
    public partial class DGAdmin
    {
        ...
        public void InitCommands()
        {
            ...
            CommandList.Add(new Command("credits", 0, Command.Behaviour.Normal,
                (sender, arguments, optarg) =>
                {
                    WriteChatToPlayer(sender, "^7MahjesticAdmin ^5by ^7Mahjestic (Ismaeel Akram)");
                }));
            ...
            CommandList.Add(new Command("discord", 0, Command.Behaviour.HasOptionalArguments,
                (sender, arguments, optarg) =>
                {
                    WriteChatToPlayer(sender, "^5Our discord is at ^7discord.io/mahjestic^5!");
                }));

            //WEBSITE
            CommandList.Add(new Command("website", 0, Command.Behaviour.HasOptionalArguments,
                (sender, arguments, optarg) =>
                {
                    WriteChatToPlayer(sender, "^5Mahjestic's website is at ^7ismaeelakram.com^5.");
                }));

            //DISCORD ROLE
            CommandList.Add(new Command("discord-role", 0, Command.Behaviour.HasOptionalArguments,
                (sender, arguments, optarg) =>
                {
                    if (!sender.SetGroup("discord", database))
                    {
                        WriteChatToPlayer(sender, "^5There has been an error. Please ask an admin to give you the ^7Discord Member ^5rank.");
                    }
                    else
                    {
                        WriteChatToPlayer(sender, "^5You have been given the ^7Discord Member ^5rank.");
                    }
                }));
